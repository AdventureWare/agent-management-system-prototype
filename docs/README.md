...
- [Planning System Spec](./planning-system.md): implementation plan for a dedicated planning surface with structured horizons, decomposition, capacity checks, and later AI-assisted planning.
