			...
			tasks: [
				{
					...
					successCriteria: 'A reviewer can verify the task brief and queued work.',
					readyCondition: 'The source documents are available and the task is unblocked.',
					expectedOutcome: 'A worker thread receives a clear launch contract for this task.',
					projectId: 'project_1',
					area: 'product',
					goalId: '',
					priority: 'medium',
